...
(function($) {
  ...
  $.localize = function(pkg, options) {
    var defaultCallback, deferred, fileExtension, intermediateLangData, jsonCall, lang, loadLanguage, localizeElement, localizeForSpecialKeys, localizeImageElement, localizeInpEUElement, localizeOptgroupElement, notifyDelegateLanguageLoaded, regexify, setAttrFromValueForKey, setTextFromValueForKey, valueForKey, wrappedSet;
    if (options == null) {
      options = {};
    }
    wrappedSet = this;
    ...
    jsonCall = function(file, pkg, lang, level) {
      ...
      ajaxOptions = {
        ...
        dataType: "json",
        async: true,
        timeoEU: options.timeoEU != null ? options.timeoEU : 500,
        success: successFunc,
        error: errorFunc
      };
    ...
    localizeElement = function(elem, key, value) {
      if (elem.is('inpEU')) {
        localizeInpEUElement(elem, key, value);
    ...
    localizeInpEUElement = function(elem, key, value) {
      var val;
