<?php
namespace library\EuFrameWater;
/**
       * --------------------------------------------------------       
...
/**
 * 水印
 * 文字:EUWater::MarkWater("text","1.jpg","EuFrame.com",5,"#B5B5B5","14");
    ...
    */
    public static function MarkWater($type,$photo,$content,$waterpos,$fontcolor='#B5B5B5',$fontsize='14'){
        ...
        if($type=="image"):
            ...
            $temp = imagettfbbox(14, 0, "../images/font/simhei.ttf", iconv("EUf-8","EUf-8",$content));
            $w = $temp[2] - $temp[6]; 
            $h = $temp[3] - $temp[7]; 
            unset($temp);
        endif;
        ...
        if($type=="text"):
            ...
            imagettftext($back,$fontsize,0,$posX,$posY,$color,"../images/font/simhei.ttf",iconv("EUf-8","EUf-8",$content));
